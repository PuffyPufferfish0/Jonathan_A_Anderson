...
B.S. Computer Engineering | Expected Graduation 2028
...
Farmhand
    ...
    Handled the transport and care of livestock

    Conducted maintenance tasks including cleaning, mowing, and pond-care
...
line cook
    ...
    Operate kitchen equipment (fryers, dough machine, food processor, pizza oven)
...
Climbing Gym | Wright-State University | 2024-2026
    ...
    Checkout equipment and organize stock

    Belay climbers on the high wall
...
Blink3D Engine Development
    ...
    Goal was to design a custom 3d modeling software to make n64 inspired graphics
...
Midwest-Slop Sports
    ...
    Directed a team of 4 to design and ship Midwest Slop in under 2 weeks securing the overall best narrative in the 2026 Wright-State game jam.
...
Hobbies
    ...
    Woodworking: I was in 4H from age 8-18, and I entered a woodworking project every year.

    Guitar: I play many styles of guitar and as of right now have built two guitars of my own.

    NSA codebreaker: I believe I was one of only two students at wright state to make it past task 2 of the 25-26 codebreaker.

    3d print engineering development: I love working with 3D modeling, I know solidworks, but I like fusion360 for personal use. I enjoy useful 3D prints.

    Electronics setup: I enjoy hacking and setting up my consoles, and electronics more than actually using them most of the time.

    Car Maintenance: Rather than a taking my vehicle to a mechanic, I will fix it myself 100% of the time. I am familiar with Mazda, Honda, and Subaru.

    Fishing: I enjoy fishing in a local creek or river in my free time.

    FCA: Back in high school, I was a leader in the Fellowship of Christian athletes.
